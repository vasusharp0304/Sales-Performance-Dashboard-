...
|-------------------|-----------------------------------|
| Data Ingestion     | Python (Pandas, NumPy)            |
| Data Storage       | SQL (Star Schema – Kimball)       |
| Data Transformation| Python + SQL                      |
| Visualization      | Power BI (DAX, Bookmarks, Drill-through) |
...
| Opportunity Funnel |
|--------------------|
| ![Opportunity Funnel](OpportunityFunnel.png) |
